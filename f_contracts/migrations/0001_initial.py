...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trend_code', models.CharField(max_length=5, unique=True, verbose_name='Trend Approval Status Code')),
                ('trend_title', models.CharField(blank=True, max_length=55, null=True, unique=True, verbose_name='Trend Approval Status Title')),
                ('comments', models.CharField(blank=True, max_length=2000, null=True, verbose_name='Comments')),
            ],
            options={
